#!/usr/bin/env python3
"""Atomically publish the Console deployment-status v1 record.

The CT 102 deploy service calls this after every meaningful phase.  It does not
run Docker or systemd commands itself; that keeps privileged deployment work out
of the Console container and makes failure records explicit.
"""
